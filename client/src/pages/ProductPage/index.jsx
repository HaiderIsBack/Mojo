            ...
            <div className="grid grid-cols-12">
                ...
                <div className="col-span-12 md:col-span-6 p-5">
                    ...
                    }
                    {
                        ...
                        (<h3 className="text-gray-400 my-1">{product.category}</h3>)
                    }
                    {
                        // loading ?
                    ...
                    }
                    {
                        ...
                        (<div className="flex gap-3">
                            <button className="flex items-center gap-2 border-[1px] border-black px-2 py-1 cursor-pointer action-btn relative overflow-hidden hover:bg-blue-700 hover:text-white hover:border-blue-700 duration-200">
                                <Shuffle />
                                Compare
                            </button>
                            <button className="flex items-center gap-2 border-[1px] border-black px-2 py-1 action-btn relative overflow-hidden hover:bg-blue-700 hover:text-white hover:border-blue-700 duration-200">
