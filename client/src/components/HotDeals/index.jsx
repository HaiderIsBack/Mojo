...
const HotDeals = () => {
    ...
    return (
        <div className="hotdeals container mx-auto w-full py-20">
            <center>
                <h3 className='inline-block text-2xl font-bold uppercase border-b-2 border-blue-600 mb-[-2px]'>Todays Hot Deals</h3>
            </center>
            <div className="w-full grid grid-cols-12 gap-5 border-t-2 border-gray-300 py-10">
                <div className="col-span-12 lg:col-span-4 px-5 lg:px-0 text-center">
                    <div className="w-full h-[400px] bg-white border-[1px] border-gray-300 rounded-lg relative overflow-hidden group">
    ...
    return (
        ...
        { !(isExpired) ? (<div className="flex justify-center items-center gap-2 my-3">
            <div className="box p-3 bg-white border-2 border-blue-600 rounded-md">
                <h6 className='text-blue-600'>{time.days}</h6>
                <p className='text-xs'>Days</p>
            </div>
            :
            <div className="box p-3 bg-white border-2 border-blue-600 rounded-md">
                <h6 className='text-blue-600'>{time.hours}</h6>
                <p className='text-xs'>Hours</p>
            </div>
            :
            <div className="box p-3 bg-white border-2 border-blue-600 rounded-md">
                <h6 className='text-blue-600'>{time.minutes}</h6>
                <p className='text-xs'>Minutes</p>
            </div>
            :
            <div className="box p-3 bg-white border-2 border-blue-600 rounded-md">
                <h6 className='text-blue-600'>{time.seconds}</h6>
