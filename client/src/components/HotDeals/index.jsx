            ...
            <Swiper className='block lg:hidden border-t-2 border-gray-300 py-10' loop={false} slidesPerView={1}>
                ...
                <div className="px-5 lg:px-0 text-center">
                    <div className="w-full h-[325px] lg:h-[400px] bg-white border-[1px] border-gray-300 rounded-lg relative overflow-hidden group">
                        <img src="https://mojo-backend.vercel.app/compressed/Xbox-one-s.webp" alt="" className='w-full h-full scale-75 group-hover:scale-100 duration-300 cursor-pointer object-cover drop-shadow-lg' />
                        <button className='absolute bottom-[-25%] left-0 w-full bg-blue-600 text-white py-3 opacity-0 group-hover:opacity-100 group-hover:bottom-0 duration-300'>Add to Cart</button>
                ...
                <div className="px-5 lg:px-0 text-center">
                    <div className="w-full h-[325px] lg:h-[400px] bg-white border-[1px] border-gray-300 rounded-lg relative overflow-hidden group">
                        <img src="https://mojo-backend.vercel.app/compressed/spiderman-mask.webp" alt="" className='w-full h-full scale-75 group-hover:scale-100 duration-300 cursor-pointer object-cover drop-shadow-lg' />
                        <button className='absolute bottom-[-25%] left-0 w-full bg-blue-600 text-white py-3 opacity-0 group-hover:opacity-100 group-hover:bottom-0 duration-300'>Add to Cart</button>
                ...
                <div className="col-span-12 lg:col-span-4 px-5 lg:px-0 text-center">
                    <div className="w-full h-[325px] lg:h-[400px] bg-white border-[1px] border-gray-300 rounded-lg relative overflow-hidden group">
                        <img src="https://mojo-backend.vercel.app/compressed/ps5-controller-front.webp" alt="" className='w-full h-full scale-75 group-hover:scale-100 duration-300 cursor-pointer object-cover drop-shadow-lg' />
                        <button className='absolute bottom-[-25%] left-0 w-full bg-blue-600 text-white py-3 opacity-0 group-hover:opacity-100 group-hover:bottom-0 duration-300'>Add to Cart</button>
